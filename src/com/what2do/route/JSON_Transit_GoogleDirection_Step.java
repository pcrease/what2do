...
public class JSON_Transit_GoogleDirection_Step {
	...
	public void addSteps(JSON_Transit_GoogleDirection_SubStep step) {
		if (steps==null){steps= new ArrayList<JSON_Transit_GoogleDirection_SubStep>();}
